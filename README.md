...
<details>
  ...
  document.getElementById("sstop_slider_div").innerHTML += '<input onchange="window.timer.set_interval(this.value);" id="sstop_slider" type="range" min="100" max="10000" value="1500" style="position: absolute;">'
